...
export default function Leaderboard() {
  ...
  return (
    ...
    >
      ...
      {/* Record Match Button */}
      <div className="fixed bottom-0 left-0 right-0 p-4 pb-[calc(1rem+env(safe-area-inset-bottom))] bg-gradient-to-t from-[var(--color-bg)] via-[var(--color-bg)] to-transparent">
        <Link
          to="/record"
